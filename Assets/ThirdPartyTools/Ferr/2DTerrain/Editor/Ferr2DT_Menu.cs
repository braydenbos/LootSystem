...
public class Ferr2DT_Menu {
    ...
    public static void AddEdgePoints(GameObject parent, bool keepUpdating)
    {
	    ...
	    AutoGenerateEdgePoints generator = gameObject.GetOrAddComponent<AutoGenerateEdgePoints>();
	    generator.Generate();
	    generator.KeepUpdating = true;
	    generator.KeepUpdating = keepUpdating;
    }
