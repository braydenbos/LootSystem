...
namespace Ferr {
	public class EditorTools {
		...
		public static void DrawPolyLine(List<Vector2> aPts, bool aClosed) {
			if (Event.current.type != UnityEngine.EventType.Repaint || aPts.Count < 2) {
				return;
			}
	    ...
	    public static Vector2 RectHandle   (Vector2 aPos, Rect aRect, Rect aBounds) {
	        ...
	        if (selectedHandle == handleID && Event.current.type == UnityEngine.EventType.MouseDrag) {
		...
		#region Cap methods
		public static void EmptyCap(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aEvent) {
            if (aEvent == UnityEngine.EventType.Layout){
                HandleUtility.AddControl(aControlID, HandleUtility.DistanceToRectangle(aPosition, aRotation, aSize));
            }
		}
		public static void CircleCapBase(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aEvent) {
			if (aEvent == UnityEngine.EventType.Repaint) {
				...
				GL.End();
			} else if (aEvent == UnityEngine.EventType.Layout) {
				HandleUtility.AddControl(aControlID, HandleUtility.DistanceToRectangle(aPosition, aRotation, aSize));
			}
		}
		public static void ImageCapBase(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, Texture2D aTex, UnityEngine.EventType aEvent) {
            if (aEvent == UnityEngine.EventType.Repaint ) {
				Material  mat          = CapMaterial2D;
        ...
        public static void CubeCapDirBase(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, Vector3 aScale, UnityEngine.EventType aEvent) {
			if (aEvent == UnityEngine.EventType.Repaint) {
				aPosition  = Handles.matrix.MultiplyPoint(aPosition);
		...
		public static void DiamondCapDir(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aEvent) {
			if (aEvent == UnityEngine.EventType.Repaint) {
				aPosition  = Handles.matrix.MultiplyPoint(aPosition);
		...
		public static void ArrowCapDirBase(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, Vector3 aDir, UnityEngine.EventType aEvent) {
			if (aEvent == UnityEngine.EventType.Repaint) {
				aPosition  = Handles.matrix.MultiplyPoint(aPosition);
		...
		public static void ArrowCapXP(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			ArrowCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(1, 0, 0), aType);
		}
		public static void ArrowCapXN(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			ArrowCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(-1, 0, 0), aType);
		}
		public static void ArrowCapZP(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			ArrowCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(0, 0, 1), aType);
		}
		public static void ArrowCapZN(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			ArrowCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(0, 0, -1), aType);
		}
		public static void ArrowCapYP(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			ArrowCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(0, 1, 0), aType);
		}
		public static void ArrowCapYN(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			ArrowCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(0, -1, 0), aType);
		}
		
		public static void BarCapX(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			CubeCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(1, .25f, .25f), aType);
		}
		public static void BarCapY(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			CubeCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(.25f, 1, .25f), aType);
		}
		public static void BarCapZ(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
			CubeCapDirBase(aControlID, aPosition, aRotation, aSize, new Vector3(.25f, .25f, 1), aType);
		}
		public static void BarCapXZ(int aControlID, Vector3 aPosition, Quaternion aRotation, float aSize, UnityEngine.EventType aType) {
