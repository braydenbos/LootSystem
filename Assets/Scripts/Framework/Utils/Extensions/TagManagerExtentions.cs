...
public static class TagManagerExtentions
{
    ...
    public static List<GameObject> FindAllWithTag(string tag)
    {
        var tagManagers = new List<GameObject>();
        foreach (var tagManager in _tagManagers)
        {
            if (tagManager.HasTag(tag)) tagManagers.Add(tagManager.gameObject);
        }
    ...
    public static List<GameObject> FindAllWithTags(List<string> tags)
    {
        var tagManagers = new List<GameObject>();
        foreach (var tagManager in _tagManagers)
        {
            if (tagManager.HasTags(tags)) tagManagers.Add(tagManager.gameObject);
        }
